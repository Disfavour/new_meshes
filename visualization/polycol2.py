...
pc = PolyCollection(quads_points1, facecolors='white', edgecolors='red')
pc.set_alpha(0.2)
#pc.set_array(np.ones(quads.shape[0]))   # scalar -> cell
ax.add_collection(pc)

# for key, value in voronoi_volume.items():
#     idx = value[0]-1
#     print(int(idx))
#     print(key, ' -> ', value, type(key), type(value), points[int(idx)])
