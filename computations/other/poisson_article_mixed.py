...
if __name__ == '__main__':
    ...
    import os
    mesh_name = f'meshes/rectangle/rectangle_1_small_quadrangle.msh'
    #'meshes/rectangle/rectangle_21_quadrangle.msh'
    
    k = ufl.as_matrix([[1, 0],
                       [0, 1]])
    
    mesh_name = f'meshes/rectangle/rectangle_0_triangle.msh'
    finite_element = basix.ufl.element("Lagrange", 'triangle', 1)
    ...
    mesh_name = f'meshes/rectangle/rectangle_0_triangle.msh'
    finite_element = basix.ufl.element("Lagrange", 'triangle', 2)
    print(solve(mesh_name, finite_element, k))

    mesh_name = f'meshes/rectangle/rectangle_0_triangle.msh'
    finite_element = basix.ufl.enriched_element([basix.ufl.element("Lagrange", 'triangle', 2), basix.ufl.element("Bubble", 'triangle', 3)])
    print(solve(mesh_name, finite_element, k))

    print()
    
    mesh_name = f'meshes/rectangle/rectangle_0_quadrangle.msh'
    finite_element = basix.ufl.element("Lagrange", 'quadrilateral', 1)
    print(solve(mesh_name, finite_element, k))

    mesh_name = f'meshes/rectangle/rectangle_0_quadrangle.msh'
    finite_element = basix.ufl.enriched_element([basix.ufl.element("Lagrange", 'quadrilateral', 1), basix.ufl.element("Bubble", 'quadrilateral', 2)])
    print(solve(mesh_name, finite_element, k))

    mesh_name = f'meshes/rectangle/rectangle_0_small_quadrangle.msh'
    finite_element = basix.ufl.element("Lagrange", 'quadrilateral', 1)
    print(solve(mesh_name, finite_element, k))
