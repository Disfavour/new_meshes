...
article_dir = os.path.join('images', 'article_1_colour')
...
def image_6(k, fname, legend=legend, ymin=None, ymax=None):
    ...
    for j in range(data.shape[1]):
        # if j == 1:
        #     ax.plot(data[:, j, 1], data[:, j, i], 'o-', markersize=6*np.sqrt(2))
        # else:
...
if __name__ == '__main__':
    ...
    # ymax=1e-2
    image_6(ks[0], os.path.join(article_dir, 'nodes_6-1.pdf'), legend)
    image_6(ks[1], os.path.join(article_dir, 'nodes_6-2.pdf'), legend)#, ymin=1e-4)

    image_7(ks[0], os.path.join(article_dir, 'nodes_7-1.pdf'), legend)
    image_7(ks[1], os.path.join(article_dir, 'nodes_7-2.pdf'), legend)

    image_9(ks[0], os.path.join(article_dir, 'nodes_9-1.pdf'), legend)
    image_9(ks[1], os.path.join(article_dir, 'nodes_9-2.pdf'), legend)

    image_11(ks[0], os.path.join(article_dir, 'nodes_11-1.pdf'), legend)
    image_11(ks[1], os.path.join(article_dir, 'nodes_11-2.pdf'), legend)
